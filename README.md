...
一位熱衷於 **機器學習 (ML)** 與 **金融量化 (Quantitative Finance)** 的資工學生。我致力於將數據科學應用於市場分析，並具備構建完整 **全端系統** 與 **雲端架構** 的實作經驗。
...
*   **雲端服務實作**: 熟悉 **GCP (Google Cloud Platform)** 環境，能運用雲端資源進行服務部署與運作。
...
*   **全端技術**: Node.js, React, FastAPI, SQL/NoSQL
*   **基礎設施**: Google Cloud Platform (GCP), Docker, Git
